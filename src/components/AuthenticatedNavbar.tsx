                ...
                <AnimatePresence>
                  {isProfileOpen && (
                    ...
                    >
                      ...
                      <Link to="/dashboard" className="block px-4 py-2 text-gray-700 hover:bg-indigo-50 flex items-center">
                        <FaTachometerAlt className="mr-2" /> Dashboard
                      </Link>
                      <Link to="/dashboard/user-profile" className="block px-4 py-2 text-gray-700 hover:bg-indigo-50 flex items-center">
                        <FaUser className="mr-2" /> Profile
                      </Link>
                      <Link to="/dashboard/settings" className="block px-4 py-2 text-gray-700 hover:bg-indigo-50 flex items-center">
