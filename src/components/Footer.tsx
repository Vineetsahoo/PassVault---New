...
const Footer: React.FC<FooterProps> = ({ className = '' }) => {
  ...
  return (
    <footer className={`bg-gradient-to-br from-indigo-950 via-blue-950/95 to-slate-900 text-white relative overflow-hidden backdrop-blur-xl ${className}`}>
      ...
      <div className="container mx-auto px-6 py-24 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-20 pb-10 border-b border-indigo-800/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col items-center md:items-start">
            <h3 className="font-bold text-xl mb-6 relative inline-flex items-center">
            ...
            <p className="text-gray-300 text-base mb-6 text-center md:text-left leading-relaxed">
        ...
        <div className="mt-20 pt-10 text-center relative">
          ...
          <div className="mt-6 text-sm text-gray-500 font-medium">
            Crafted with ♥️ by the PassVault Team
          </div>
        </div>
      </div>
    </footer>
